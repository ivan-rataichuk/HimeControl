...
namespace HomeControlModel.Settings
{
    public static class FilesLocation
    {
        public static readonly string channelsXML = @"C:\HomeControlTest\channels.xml";
        public static readonly string deviceSettingsXML = @"C:\HomeControlTest\device-settings.xml";
